					...
					<div className='card tw-max-w-lg'>
						<div className='card-body'>
							...
							<div className='card-text alert alert-warning mono tw-text-xs tw-mx-auto'>
								...
								others) in order for some projects to compile.
							</div>
							<div className='card-text alert alert-warning mono tw-text-xs tw-mx-auto'>
								<i className='bi bi-exclamation-circle tw-mr-1'></i>
								For some projects, the expected directory
								structure of PLUGIN_SDK_DIR may differ than what
								is provided. In that case, simply copy the
								directories under the lib and src directories to
